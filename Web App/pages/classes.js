    ...
    <div className="flex h-screen bg-gray-100">
      ...
      <div className="flex-1 flex flex-col bg-gray-50">
        ...
        <div className="bg-white shadow-md px-8 py-4 flex justify-between items-center">
          <h1 className="text-3xl font-bold text-gray-700">Classes</h1>
        ...
        {/* Class Table Section */}
        <div className="p-8">
          <h2 className="text-xl font-semibold text-gray-800 mb-6">Manage Classes</h2>

          <div className="overflow-x-auto bg-white rounded-xl shadow-lg">
            <table className="min-w-full table-auto">
              <thead>
                <tr className="bg-[#55823d] text-white text-left">
    ...
    classData.map((cls) => (
      <tr key={cls._id} className="border-b">
        ...
        <td className="p-4 space-x-2">
          <button onClick={() => router.push(`/class-details?className=${encodeURIComponent(cls.className)}`)}
